...
class SwinTransformer_(Backbone):
...
def build_swint_backbone(cfg, input_shape):
    ...
    # sam = sam_model_registry["vit_h"](checkpoint="./SwinT_detectron2-main_sam/sam_vit_h_4b8939.pth")
...
def build_swint_fpn_backbone(cfg, input_shape: ShapeSpec):
    ...
    for name, param in bottom_up.named_parameters():
        print(f"Layer name: {name}")
        print(f"Layer parameters: {param.shape}")
